            ...
            <div class="col-md-8">
                ...
                <div class="my-3 p-3 bg-white rounded shadow-sm">
                    <div class="d-flex justify-content-between border-bottom border-gray pb-2 mb-0">
                        <h6 class="">{{ $notification->data['text'] }}</h6>
                        <a href="{{ route('notifications.update', $notification) }}">{{ $notification->read() ? 'Mark as readed' : 'Mark as unreaded.' }}</a>
                    </div>
                    <div class="media text-muted pt-3">
                        ...
                        <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
                            ...
                            <span class="d-block">{{ '@' . $notification->data['text'] }}</span>
                        </div>
                    </div>
